...
LoadAdjustRelayParallelBinary<numRelays> coarseLoadAdjust = LoadAdjustRelayParallelBinary<numRelays>(relayDriver, true); // driver, activeRelaysIncreaseLoad (true if resistors are through NO, false if through NC)
